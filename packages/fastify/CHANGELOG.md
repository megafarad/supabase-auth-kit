...
- 1130b05: Add `requireIdentity` to both adapters, over a new `enforceIdentity` in core.
...
- Updated dependencies [1130b05]
  - @sirhc77/supabase-auth-kit-core@0.4.0
...
- Updated dependencies [6d59413]
  - @sirhc77/supabase-auth-kit-core@0.3.0
...
- Updated dependencies [b78de4c]
  - @sirhc77/supabase-auth-kit-core@0.2.0
...
- Updated dependencies [e46ff7e]
  - @sirhc77/supabase-auth-kit-core@0.1.1
